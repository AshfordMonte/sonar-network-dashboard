...
## Smoke testing (no browser required)

This repo includes a lightweight smoke test that boots the server and verifies
the main HTML pages and `/health` respond as expected.
